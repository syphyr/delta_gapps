...
APKLIST=$(find text-to-speech-arm/optional/apkbin/app/GoogleTTS -name com.*.apk | sort)
FILENAME="GoogleTTS.apk"
INDIR=text-to-speech-arm
NAME=gapps-tts
VER=arm-klmn
...
echo "Google Text-to-Speech add-on for 4.4.4+ (arm) (replaces stock text-to-speech)" | tout
echo "" | tout
