...
APKLIST=$(find translate-arm/optional/apkbin -name com.*.apk | sort)
FILENAME=GoogleTranslate.apk
INDIR=translate-arm
NAME=gapps-translate
VER=arm-klmn
...
echo "Google Translate add-on for 4.4.4+ (arm)" | tout
echo "" | tout
