...
APKLIST=$(find gapps-base-arm64-810/optional/gms -name com.*.apk | sort)
FILENAME=PrebuiltGmsCore.apk
APKPATH=$(find gapps-base-arm64-810/system/priv-app/Phonesky -name com.*.apk | sort)
APKNAME=Phonesky.apk
INDIR=gapps-base-arm64-810
...
echo "Oreo Base Gapps package for 8.1.0 (arm64)" | tout
echo "" | tout
