...
APKLIST=$(find gapps-base-arm-900/optional/gms -name com.*.apk | sort)
FILENAME=PrebuiltGmsCore.apk
APKPATH=$(find gapps-base-arm-900/system/priv-app/Phonesky -name com.*.apk | sort)
APKNAME=Phonesky.apk
INDIR=gapps-base-arm-900
...
echo "Pie Base Gapps package for 9.0.0 (arm)" | tout
echo "" | tout
