...
case "$1" in
  ...
  post-restore)
    ...
    chmod 644 /system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/*
    chmod 644 /system/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/*
    ...
    chown 0:2000 /system/vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7
    chown 0:2000 /system/vendor/pittpatt/models/detection/yaw_roll_face_detectors.6
