...
APKLIST=$(find photos-arm64/optional/apkbin -name com.*.apk | sort)
FILENAME=GooglePhotos.apk
INDIR=photos-arm64
NAME=gapps-photos
VER=arm64-lmn
...
echo "Google Photos add-on for 5.0.2+ (arm64) (replaces stock gallery)" | tout
echo "" | tout
