...
APKLIST=$(find phone-arm64/system/priv-app/GoogleDialer -name com.*.apk | sort)
...
echo "Google Phone add-on for 6.0.0+ (arm64) (replaces stock dialer) *must be set as default dialer*" | tout
echo "" | tout
