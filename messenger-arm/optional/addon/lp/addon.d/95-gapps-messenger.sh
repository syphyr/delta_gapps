...
priv-app/GoogleMessenger/lib/arm/libframesequence.so
priv-app/GoogleMessenger/lib/arm/libgiftranscode.so
EOF
}
...
case "$1" in
  ...
  post-restore)
    ...
    chmod 755 /system/priv-app/GoogleMessenger/lib/arm
  ;;
esac
