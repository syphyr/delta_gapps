...
APKLIST=$(find gapps-base-arm-601/optional/gms -name com.*.apk | sort)
FILENAME=PrebuiltGmsCore.apk
APKPATH=$(find gapps-base-arm-601/system/priv-app/Phonesky -name com.*.apk | sort)
APKNAME=Phonesky.apk
INDIR=gapps-base-arm-601
...
echo "Marshmallow Base Gapps package for 6.0.1 (arm)" | tout
echo "" | tout
