...
APKLIST=$(find gapps-base-arm-800/optional/gms -name com.*.apk | sort)
FILENAME=PrebuiltGmsCore.apk
APKPATH=$(find gapps-base-arm-800/system/priv-app/Phonesky -name com.*.apk | sort)
APKNAME=Phonesky.apk
INDIR=gapps-base-arm-800
...
echo "Oreo Base Gapps package for 8.0.0 (arm)" | tout
echo "" | tout
