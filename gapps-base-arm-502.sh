...
APKLIST=$(find gapps-base-arm-502/optional/gms -name com.*.apk | sort)
FILENAME=PrebuiltGmsCore.apk
APKPATH=$(find gapps-base-arm-502/system/priv-app/Phonesky -name com.*.apk | sort)
APKNAME=Phonesky.apk
INDIR=gapps-base-arm-502
...
echo "Lollipop Base Gapps package for 5.0.2 (arm)" | tout
echo "" | tout
