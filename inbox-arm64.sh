...
APKLIST=$(find inbox-arm64/optional/apkbin -name com.*.apk | sort)
FILENAME=GoogleInbox.apk
INDIR=inbox-arm64
NAME=gapps-inbox
VER=arm64-lmn
...
echo "Google Inbox add-on for 5.0.2+ (arm64) (replaces stock email client)" | tout
echo "" | tout
