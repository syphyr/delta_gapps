...
APKLIST=$(find instant-apps-arm/optional/apkbin/app/InstantApps -name com.*.apk | sort)
FILENAME=InstantApps.apk
INDIR=instant-apps-arm
NAME=gapps-instantapps
VER=arm-mn
...
echo "Google Play Services for Instant Apps add-on for 6.0.0+ (arm)" | tout
echo "" | tout
