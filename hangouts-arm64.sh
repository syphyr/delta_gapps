...
APKLIST=$(find hangouts-arm64/optional/apkbin -name com.*.apk | sort)
FILENAME=Hangouts.apk
INDIR=hangouts-arm64
NAME=gapps-hangouts
VER=arm64-lmn
...
echo "Google Hangouts add-on for 5.0.2+ (arm64)" | tout
echo "" | tout
